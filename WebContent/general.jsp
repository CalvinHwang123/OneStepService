...
<link rel="stylesheet" type="text/css"
	href=<%=path+"/assets/js/gritter/css/jquery.gritter.css" %>/>
...
<body>
	...
	<div class="row mt">
		<div class="col-lg-6 col-md-6 col-sm-12">
			...
			<div class="showback">
				<h4>
					<i class="fa fa-angle-right"></i> Basic Progress Bars
				</h4>
				<div class="progress">
			...
			<div class="showback">
				<h4>
					<i class="fa fa-angle-right"></i> Stripped Progress Bars
				</h4>
				<div class="progress progress-striped">
					<div class="progress-bar progress-bar-success" role="progressbar"
						aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
			...
			<div class="showback">
				<h4>
					<i class="fa fa-angle-right"></i> Animated Progress Bars
				</h4>
			...
			<div class="showback">
				<h4>
					<i class="fa fa-angle-right"></i> Modal Example
				</h4>
				...
				<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">Hi there, I am a Modal Example for
								Dashgum Admin Panel.</div>
			...
			<div class="showback">
				...
				<a id="add-regular" class="btn btn-default btn-sm"
					...
					id="remove-all" class="btn btn-danger  btn-sm" href="general.html#">Remove
					all</a>
			</div>
			<!-- /showback -->
		...
		<div class="col-lg-6 col-md-6 col-sm-12">
			...
			<div class="showback">
				<h4>
					<i class="fa fa-angle-right"></i> Alerts Examples
				</h4>
			...
			<div class="showback">
				<h4>
					<i class="fa fa-angle-right"></i> Dismissable Alert
				</h4>
			...
			<div class="showback">
				<h4>
					<i class="fa fa-angle-right"></i> Badges
				</h4>
				<span class="badge">5</span> <span class="badge bg-primary">10</span>
				<span class="badge bg-success">15</span> <span class="badge bg-info">20</span>
				<span class="badge bg-inverse">25</span> <span
					class="badge bg-warning">30</span> <span class="badge bg-important">35</span>
			</div>
			<!-- /showback -->
			...
			<div class="showback">
				<h4>
					<i class="fa fa-angle-right"></i> Labels
				</h4>
	...
	<div class="text-center">
		...
		<a href="general.html#" class="go-top"> <i class="fa fa-angle-up"></i>
		</a>
	</div>
	...
	<script src=<%=path+"/assets/js/jjquery-1.8.3.min.js"%>></script>
	<script src=<%=path+"/assets/js/bootstrap.min.js"%>></script>
	<script class="include" type="text/javascript"
		src=<%=path+"/assets/js/jquery.dcjqaccordion.2.7.js"%>></script>
	...
	<script type="text/javascript"
		src=<%=path+"/assets/js/gritter/js/jquery.gritter.js"%>></script>
