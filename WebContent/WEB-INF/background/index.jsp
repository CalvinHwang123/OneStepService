...
<body>
	...
	<div class="left-nav">
		<div id="side-nav">
			<ul id="nav">
			<c:forEach items="${oneMenuList}" var="menuOne" begin="0">
			<li><a href="javascript:;"> <i class="iconfont">&#xe6b8;</i>
						<cite><c:out value="${menuOne.menuName}"></c:out></cite> <i class="iconfont nav_right">&#xe697;</i>
				</a>
				<c:forEach items="${twoMenuList}" var="menuTwo" begin="0">
				<c:if test="${menuOne.menuID == menuTwo.menuPID}">
				
				<ul class="sub-menu">
						<li><a _href="${menuTwo.url}"> <i class="iconfont">&#xe6a7;</i>
								<cite><c:out value="${menuTwo.menuName}"></c:out></cite>
						</a>
				</ul>
