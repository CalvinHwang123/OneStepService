...
<!-- Custom Theme files -->
<link href="portal/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="portal/css/style.css" rel="stylesheet" type="text/css" media="all" /> 
<link href="portal/css/menu.css" rel="stylesheet" type="text/css" media="all" /> <!-- menu style --> 
<link href="portal/css/ken-burns.css" rel="stylesheet" type="text/css" media="all" /> <!-- banner slider --> 
<link href="portal/css/animate.min.css" rel="stylesheet" type="text/css" media="all" /> 
<link href="portal/css/owl.carousel.css" rel="stylesheet" type="text/css" media="all"> <!-- carousel slider -->  
<!-- //Custom Theme files -->
<!-- font-awesome icons -->
...
<script src="portal/js/jquery-scrolltofixed-min.js" type="text/javascript"></script>
<script>
    $(document).ready(function() {
...
<!-- 	</div> -->
	...
	<div class="header">
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				<ul>
					...
					<li class="dropdown head-dpdn">
						<a href="contact.html" class="dropdown-toggle"><i class="fa fa-map-marker" aria-hidden="true"></i> 定位</a>
					</li> 
					<li class="dropdown head-dpdn">
						<a href="card.html" class="dropdown-toggle"><i class="fa fa-credit-card-alt" aria-hidden="true"></i> 我的银行卡</a>
					</li> 
					<li class="dropdown head-dpdn">
		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				<div class="header-logo">
					<h1><a href="index.html"><span>帝</span>六 <i>人</i></a></h1>
					<h6>DLR.COM</h6> 
				</div>	
		...
		<div class="header-three"><!-- header-three -->
			<div class="container">
				...
				<div class="move-text">
					<div class="marquee"><a href="offers.html"> 今日红包优惠卡入口 <span> </span> <span> </span></a></div>
            ...
            <div class="carousel-inner" role="listbox">  
                <div class="item active"><!-- First-Slide -->
                    ...
                    <div class="carousel-caption kb_caption kb_caption_right">
                        <h3 data-animation="animated flipInX">超过187,863  <span>设计人才</span> 供您挑选</h3>
                        <h4 data-animation="animated flipInX">More than 187863 design talents for you to choose</h4>
                    </div>
                </div>  
                <div class="item"> <!-- Second-Slide -->
                    ...
                    <div class="carousel-caption kb_caption kb_caption_right">
                        ...
                        <h4 data-animation="animated fadeInUp">Find professional people, do professional things</h4>
                    </div>
                </div>
                ...
                <div class="item"><!-- Third-Slide -->
                    ...
                    <div class="carousel-caption kb_caption kb_caption_center">
                        ...
                        <h4 data-animation="animated flipInX">Providing service for 6000000 business owners</h4>
                    </div>
                </div>
								...
								<div id="owl-demo" class="owl-carousel"> 
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products.html"><img src="portal/images/e1.png" alt="img"></a>
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											...
											<a href="products.html"><img src="portal/images/e2.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											...
											<a href="products.html"><img src="portal/images/e3.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products.html"><img src="portal/images/e4.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
						...
						<div role="tabpanel" class="tab-pane fade" id="carl" aria-labelledby="carl-tab">
							<div class="tabcontent-grids">
								...
								<div id="owl-demo1" class="owl-carousel"> 
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products1.html"><img src="portal/images/f1.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											...
											<a href="products1.html"><img src="portal/images/f2.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products1.html"><img src="portal/images/f3.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>New</h6></div>
											<a href="products1.html"><img src="portal/images/f4.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
							...
							<div class="tabcontent-grids">
								...
								<div id="owl-demo2" class="owl-carousel"> 
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>New</h6></div>
											<a href="products6.html"><img src="portal/images/p1.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>20% <br> Off</h6></div>
											<a href="products6.html"><img src="portal/images/p2.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item"> 
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>Sale</h6></div>
											<a href="products6.html"><img src="portal/images/p3.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products6.html"><img src="portal/images/p4.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
							...
							<div class="tabcontent-grids">
								...
								<div id="owl-demo3" class="owl-carousel"> 
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>Sale</h6></div>
											<a href="products3.html"><img src="portal/images/h1.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											...
											<a href="products3.html"><img src="portal/images/h2.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products3.html"><img src="portal/images/h3.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products3.html"><img src="portal/images/h4.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
							...
							<div class="tabcontent-grids">
								...
								<div id="owl-demo4" class="owl-carousel"> 
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>New</h6></div>
											<a href="products4.html"><img src="portal/images/s1.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products4.html"><img src="portal/images/s2.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>20% <br>Off</h6></div>
											<a href="products4.html"><img src="portal/images/s3.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products4.html"><img src="portal/images/s4.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
			...
			<div class="add-products-row">
				<div class="w3ls-add-grids">
					<a href="products1.html"> 
						<h4>作品交易数量前 <span>10</span> 名</h4>
						<h6>Shop now <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
				</div>
				<div class="w3ls-add-grids w3ls-add-grids-mdl">
					<a href="products1.html"> 
						<h4>作品好评率前<span>10</span>名 </h4>
						<h6>Shop now <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
				</div>
				<div class="w3ls-add-grids w3ls-add-grids-mdl1">
					<a href="products.html"> 
						<h4> <span> Hurry !</span></h4>
						<h6>Shop now <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
				</div>
			...
			<div class="footer-info w3-agileits-info">
				<div class="col-md-4 address-left agileinfo">
					<div class="footer-logo header-logo">
						<h2><a href="index.html"><span>帝</span>六 <i>人</i></a></h2>
						<h6>帝六人欢迎您.</h6>
					</div>
					<ul>
						...
						<li><i class="fa fa-envelope-o"></i> <a href="mailto:example@mail.com"> 657789474@qq.com</a></li>
					</ul> 
				</div>
	...
	<div class="copy-right"> 
		<div class="container">
			<p>Copyright 2018-2018 dlr.com 版权所有 渝ICP备10202274-4号 渝B2-20080005  渝公网安备 50019002500154号 厦门帝六人网络有限公司 
互联网违法和不良信息举报电话：023-88390110 邮箱：110@dlr.com 信用厦门 国家企业信用信息公示系统(厦门)</p>
		</div>
	</div> 
	<!-- cart-js -->
	...
	<script src="portal/js/main.js"></script> <!-- Resource jQuery -->
	<!-- //menu js aim --> 
