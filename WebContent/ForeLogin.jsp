...
<body>
				...
				<ul>
					<li class="dropdown head-dpdn"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"><i
							class="fa fa-user" aria-hidden="true"></i> 我的帐户<span
							class="caret"></span></a>
					...
					<li class="dropdown head-dpdn"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"><i
							class="fa fa-percent" aria-hidden="true"></i> 我是雇主<span
							class="caret"></span></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown head-dpdn"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"><i
							class="fa fa-gift" aria-hidden="true"></i> 开店赚钱<span
							class="caret"></span></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown head-dpdn"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"><i
							class="fa fa-percent" aria-hidden="true"></i> 网站导航<span
							class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="offers.html">服务市场</a></li>
							<li><a href="offers.html">特色市场</a></li>
							<li><a href="offers.html">用户服务</a></li>


						</ul></li>
					<li class="dropdown head-dpdn"><a href="contact.html"
						class="dropdown-toggle"><i class="fa fa-map-marker"
							aria-hidden="true"></i> 定位功能</a></li>
			...
			<div class="container">
				<div class="menu">
					<div class="cd-dropdown-wrapper">
						<a class="cd-dropdown-trigger" href="#0">交易分类</a>
								...
								<ul class="cd-secondary-dropdown is-hidden">
									...
									<li class="has-children"><a href="#">MOBILE PHONES</a>
										<ul class="is-hidden">
											...
											<li class="has-children"><a href="#0">LOGO</a>
												<ul class="is-hidden">
				...
				<div class="move-text">
					<div class="marquee">
						<a href="offers.html"> 今日优惠卡入口 <span> </span> <span> </span></a>
					</div>
	...
	<div class="login-page">
		<div class="container">
			...
			<h6>
				没有账号? <a href="signup.html">立即注册 »</a>
			</h6>
