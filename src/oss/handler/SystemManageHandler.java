...
public class SystemManageHandler {
	...
	public ModelAndView menuList(HttpServletRequest req) {
		...
		List<Menu> menuListOne = systemManegeBizImpl.MenuListOne(empId);
		System.out.println("一级菜单为=====" + menuListOne);
		List<Menu> menuListTwo = systemManegeBizImpl.MenuListTwo(empId);
		System.out.println("二级菜单为=====" + menuListTwo);
